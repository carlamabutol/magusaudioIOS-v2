//
//  SubliminalListViewController.swift
//  Magus
//
...
class SubliminalListViewController: CommonViewController {
    
    private let viewModel = SubliminalListViewModel()
    ...
    @IBOutlet var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.register(AddSubliminalCell.instantiate(), forCellWithReuseIdentifier: AddSubliminalCell.identifier)
    ...
    private func setupDataSource() {
        let dataSource = RxCollectionViewSectionedReloadDataSource<SubliminalListViewModel.Section>(configureCell: { dataSource, collectionView, indexPath, item in
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: AddSubliminalCell.identifier, for: indexPath) as! AddSubliminalCell
